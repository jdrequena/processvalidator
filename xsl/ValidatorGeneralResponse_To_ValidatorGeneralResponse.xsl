   ...
   <xsl:template match="/">
      <xtccv:ValidatorGeneralResponse>
         <ns5:ResponseHeader>
            <ns5:GeneralResponse>
               <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:correlationID">
                  <ns5:correlationID>
                     <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:correlationID/@xsi:nil">
                        <xsl:attribute name="xsi:nil">
                           <xsl:value-of select="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:correlationID/@xsi:nil"/>
                        </xsl:attribute>
                     </xsl:if>
               ...
               <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:status">
                  <ns5:status>
                     <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:status/@xsi:nil">
                        <xsl:attribute name="xsi:nil">
                           <xsl:value-of select="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:status/@xsi:nil"/>
                        </xsl:attribute>
                     </xsl:if>
               ...
               <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:code">
                  <ns5:code>
                     <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:code/@xsi:nil">
                        <xsl:attribute name="xsi:nil">
                           <xsl:value-of select="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:code/@xsi:nil"/>
                        </xsl:attribute>
                     </xsl:if>
               ...
               <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:codeType">
                  <ns5:codeType>
                     <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:codeType/@xsi:nil">
                        <xsl:attribute name="xsi:nil">
                           <xsl:value-of select="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:codeType/@xsi:nil"/>
                        </xsl:attribute>
                     </xsl:if>
               ...
               <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:description">
                  <ns5:description>
                     <xsl:if test="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:description/@xsi:nil">
                        <xsl:attribute name="xsi:nil">
                           <xsl:value-of select="/xtccv:ValidatorGeneralResponse/ns5:ResponseHeader/ns5:GeneralResponse/ns5:description/@xsi:nil"/>
                        </xsl:attribute>
                     </xsl:if>
         ...
         <xtccv:responseBody>
            ...
            <xtccv:processRules>
               <xsl:for-each select="/xtccv:ValidatorGeneralResponse/xtccv:responseBody/xtccv:processRules/ns12:rule">
                  <ns12:rule>
                     <ns12:ruleID>
                        <xsl:value-of select="ns12:ruleID"/>
                     </ns12:ruleID>
                     <ns12:description>
                        <xsl:value-of select="ns12:description"/>
                     </ns12:description>
                     <ns6:status>
                        <ns6:status>
                           <xsl:value-of select="ns6:status/ns6:status"/>
                        </ns6:status>
                        <ns6:statusDetails>
                           <xsl:value-of select="ns6:status/ns6:statusDetails"/>
                        </ns6:statusDetails>
                     </ns6:status>
                     <xsl:if test="concat(ns12:exception,&quot;&quot;) != &quot;&quot;">
                        <ns12:exception>
                           <xsl:value-of select="ns12:exception"/>
                        </ns12:exception>
                     </xsl:if>
                     <xsl:if test="ns12:responsible">
                        <ns12:responsible>
                           <xsl:for-each select="ns12:responsible/ns8:role">
                              <ns8:role>
                                 <ns8:roleID>
                     ...
                     <xsl:if test="ns12:target">
                        <ns12:target>
                           <xsl:value-of select="ns12:target"/>
                        </ns12:target>
                     </xsl:if>
                     <xsl:if test="concat(ns12:expirationDate,&quot;&quot;) != &quot;&quot;">
                        <ns12:expirationDate>
                           <xsl:value-of select="ns12:expirationDate"/>
                        </ns12:expirationDate>
                     </xsl:if>
                     <ns0:additionals>
            ...
            <xsl:if test="/xtccv:ValidatorGeneralResponse/xtccv:responseBody/xtccv:result">
               <xtccv:result>
                  ...
                  <xsl:choose>
                     <xsl:when test="concat(/xtccv:ValidatorGeneralResponse/xtccv:responseBody/xtccv:result/xtccv:expirationDate,&quot;&quot;) != &quot;&quot;">
            ...
            <xsl:if test="/xtccv:ValidatorGeneralResponse/xtccv:responseBody/ns10:processDetails">
               <ns10:processDetails>
                  ...
                  <xsl:if test="/xtccv:ValidatorGeneralResponse/xtccv:responseBody/ns10:processDetails/ns10:conditions/ns10:condition">
                     <ns10:conditions>
                  ...
                  <xsl:choose>
                     <xsl:when test="/xtccv:ValidatorGeneralResponse/xtccv:responseBody/ns10:processDetails/ns0:additionals/ns0:additional">
                        <ns0:additionals>
                     ...
                     <xsl:otherwise>
                        <ns0:additionals>
                           <ns0:additional>
                              <ns0:name>
                                 <xsl:text disable-output-escaping="no">PROCESS_INFO</xsl:text>
                              </ns0:name>
                              <ns0:value>
